...
export const MainNav: React.FC = () => {
  ...
  return (
    <nav
      ...
      className="hidden md:flex flex-col items-center gap-1 py-4 px-2 w-16 shrink-0 border-r border-neutral-800/80 bg-bg-dark h-full"
    >
      {/* Logo mark */}
      <div className="w-9 h-9 rounded-xl bg-accent-blue flex items-center justify-center mb-4 shrink-0">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
      ...
      {NAV_ITEMS.map((item) => {
        ...
        return (
          <Link
            ...
            className={`
              flex flex-col items-center gap-1 p-2 rounded-xl w-12 transition-all duration-150
              ${isActive
